...
const VerifyEmail = () => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white flex items-center justify-center flex-col px-4">
      {loading && (
        <div className="mb-10 flex flex-col items-center" role="status">
          <svg
            aria-hidden="true"
            className="w-20 h-20 animate-spin text-gray-600 fill-indigo-500"
            viewBox="0 0 100 101"
            fill="none"
          ...
          >
            <path
              ...
              100.591C22.3858 100.591 0 78.2051 
            ...
            <path
              ...
              33.5531C95.2932 28.8227 92.871 
              24.3692 89.8167 20.348C85.8452 
              15.1192 80.8826 10.7231 75.2124 
              7.41289C69.5422 4.10268 63.2754 
              ...
              28.9121 86.7992 32.2913 88.1811 
              35.8758C89.083 38.2158 91.5421 
              39.6781 93.9676 39.0409Z"
              fill="currentFill"
            />
          </svg>
          <span className="my-4 text-lg">Verifying email...</span>
        </div>
      )}
      ...
      {!loading && (
        <>
          ...
          {!isAuthenticated && (
            <Link
              to="/login"
              className="inline-flex items-center justify-center px-5 py-2 mt-4 text-white bg-indigo-600 rounded hover:bg-indigo-700"
            >
              Login
              <svg
